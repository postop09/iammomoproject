  ...
  return (
    <Wrapper>
      ...
      <div>
        ...
        하기 시작했어요. 관심분야부터 취향까지 어느 것 하나 공통점이 없는, 전혀
        접점이 없는 사람들이었습니다. ‘이렇게나 공통점이 없을까’라고 생각하던
        차에, 재미있게도 프로젝트에 참여하게 된 이유가 비슷했습니다. ‘소통'
        그리고 ‘커뮤니케이션'이라는 욕구였어요. 객관적인 또는 주관적인
        조건에서는 전혀 접점이 없던 저희들이 오히려 솔직한 욕구와 각자의 생활에
        대해 이야기하면서 서로의 공통점을 발견했던 것입니다. 재미있는
        경험이었죠. 그러다 ‘전혀 비슷하지 않은 사람들, 전혀 만날 일이 없는
        사람들이 서로 소통하는 방법은 없을까? 서로 공감하는 방법은 없을까?’라는
        철학적인 질문을 서로에게 묻기 시작했습니다. 그렇다면 서로의 조건을 전혀
        알 수 없는 ‘일상에 대한 글'로 소통하는 건 어떨까라는 생각을 하게
        되었어요. 하나의 이름으로 글을 쓴다면? 익명이지만 익명같지 않은
        느낌이라면? 오히려 솔직한 글을 쓰고 일상을 나눌 수 있지 않을까라고
        생각했습니다. 접점이 없던 저희 4명이 서로에 대해 솔직하게 되면서,
